...
public:
     ...
     */
    Acceptor(
        std::shared_ptr<StateGraph> state_graph = nullptr,
        State start_state = 0,
     ...
     */
    virtual std::vector<std::shared_ptr<Walker>> get_walkers(
     ...
     */
    virtual std::vector<std::pair<std::shared_ptr<Walker>, State>> get_transitions(
     ...
     */
    virtual std::vector<std::shared_ptr<Walker>> advance(
        std::shared_ptr<Walker> walker,
     ...
     */
    virtual std::vector<std::shared_ptr<Walker>> branch_walker(
        std::shared_ptr<Walker> walker,
